...
[collective insights submit](collective-insights-submit) - Enables contribute data, `collective insights`, into the Recorded Future Intelligence Cloud.  
...
[links search](#action-links-search) - Find links based on a query  
...
--------- | -------- | ----------- | ---- | --------
**name** |  required  | Entity Name | string |
**entity_id** |  optional  | Entity ID | string |
**entity_name** |  optional  | Entity Name | string |
**entity_type** |  optional  | Entity Type | string |
**source_type** |  optional  | Sources are grouped into two types, technical analysis and Insikt Group research. Specify either technical or insikt for the type | numeric |
...
action_result.data.\*.id | string | recordedfuture entity id | ip:8.8.8.8
action_result.data.\*.name | string | recordedfuture entity name | 8.8.8.8
action_result.data.\*.type | string | recordedfuture entity type | type:IpAddress
action_result.data.\*.links.IpAddress.*.type | string | recordedfuture link type | type:Hash
...
action_result.data.\*.links.IpAddress.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.links.URL.*.id | string | recordedfuture link id | JRrjf
...
action_result.data.\*.links.URL.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.links.InternetDomainName.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.links.Hash.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.links.CyberVulnerability.*.id | string | recordedfuture link id | jesT16
...
action_result.data.\*.links.CyberVulnerability.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.links.CyberThreatActorCategory.*.id | string | recordedfuture link id | jesT16
action_result.data.\*.links.CyberThreatActorCategory.*.name | string | recordedfuture link name | Big Boss
...
action_result.data.\*.links.CyberThreatActorCategory.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.links.AttackVector.*.id | string | recordedfuture link id | jesT16
...
action_result.data.\*.links.AttackVector.*.risk_score | numeric | recordedfuture link risk score | 88
action_result.data.\*.links.AttackVector.*.criticality | string | recordedfuture link criticality | Unusual
action_result.data.\*.links.Company.*.type | string | recordedfuture link type | type:AttackVector
action_result.data.\*.links.Company.*.id | string | recordedfuture link id | jesT16
action_result.data.\*.links.Company.*.name | string | recordedfuture link name | Chengdu 404 Network Technology
...
action_result.data.\*.links.Company.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.links.FileContent.*.id | string | recordedfuture link id | jesT16
action_result.data.\*.links.FileContent.*.name | string | recordedfuture link name | jfu348f9jwdkjsalfjsdlkfjsdj8
...
action_result.data.\*.links.FileContent.*.risk_score | numeric | recordedfuture link risk score | 88
action_result.data.\*.links.FileContent.*.criticality | string | recordedfuture link criticality | Unusual
action_result.data.\*.links.Malware.*.type | string | recordedfuture link type | type:Malware
...
action_result.data.\*.links.Malware.*.risk_score | numeric | recordedfuture link risk score | 88
action_result.data.\*.links.Malware.*.criticality | string | recordedfuture link criticality | Unusual
action_result.data.\*.links.MalwareCategory.*.type | string | recordedfuture link type | type:MalwareCategory
action_result.data.\*.links.MalwareCategory.*.id | string | recordedfuture link id | JLHNoH
action_result.data.\*.links.MalwareCategory.*.name | string | recordedfuture link name | Cobalt Strike
...
action_result.data.\*.links.MalwareCategory.*.risk_score | numeric | recordedfuture link risk score | 88
action_result.data.\*.links.MalwareCategory.*.criticality | string | recordedfuture link criticality | Unusual
action_result.data.\*.links.MalwareSignature.*.type | string | recordedfuture link type | type:MalwareSignature
action_result.data.\*.links.MalwareSignature.*.id | string | recordedfuture link id | JLHNoH
action_result.data.\*.links.MalwareSignature.*.name | string | recordedfuture link name | Cobalt Strike
...
action_result.data.\*.links.MalwareSignature.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.links.MitreAttackIdentifier.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.links.Organization.*.id | string | recordedfuture link id | CWKU0
...
action_result.data.\*.links.Organization.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.links.Person.*.id | string | recordedfuture link id | CWKU0
...
action_result.data.\*.links.Person.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.links.Username.*.id | string | recordedfuture link id | CWKU0
...
action_result.data.\*.links.Username.*.risk_score | numeric | recordedfuture link risk score | 88
...
action_result.data.\*.description | string | recordedfuture detection rule title | Brute Ratel C4 (BRc4) is a red team tool authored by security researcher...
...
action_result.data.\*.rules.\*.entities.type| string | rrecordedfuture entity type | type:IpAddress
action_result.data.\*.rules.\*.entities.id| string | rrecordedfuture entity id | ip:8.8.8.8
action_result.data.\*.rules.\*.entities.id| string | rrecordedfuture entity name | 8.8.8.8
action_result.summary | string |  |
action_result.message | string |  `recordedfuture result message`  |
summary.total_objects | numeric |  `recordedfuture total objects`  |   1
summary.total_objects_successful | numeric |  `recordedfuture total objects successful`  |   1
...
action_result.data.\*.name | string | entity name | APT28
...
--------- | ---- | -------- | --------------
action_result.status | string |  `recordedfuture result status`  |   success  failed
action_result.data.\*.threatActor.\*.id| string | recorded future threat actor id | nt_jr4
...
**entity_field** |  optional  | Entity field used to describe characteristics about the IOC | string |
**entity_source_type** |  optional  | Used to describe what log source the IOC came from | string |
**event_id** |  optional  | Event unique id | string |
**event_name** |  optional  | Title of the event related to the IOC | string |
**event_type** |  optional  | Attack vector associated with the incident (C2, Phishing.. etc) | string |
**mitre_codes** |  optional  | Comma-separated list of MITRE codes associated with the IOC | string |
**malware** |  optional  | Comma separated Malware associated with the IOCs | string |
**timestamp** |  optional  | Timestamp in ISO format. | string |
